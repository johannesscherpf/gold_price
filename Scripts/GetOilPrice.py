...
gold_ticker = 'GLD'
gold_data = yf.download(gold_ticker, start=start_date, interval='1d')[['Close']]

# US-Dollar-Index
dxy_ticker = 'DX-Y.NYB'
dxy_data = yf.download(dxy_ticker, start=start_date, interval='1d')[['Close']]

# S&P 500 Index
sp500_ticker = '^GSPC'
sp500_data = yf.download(sp500_ticker, start=start_date, interval='1d')[['Close']]

# Rohölpreise
oil_ticker = 'CL=F'
oil_data = yf.download(oil_ticker, start=start_date, interval='1d')[['Close']]
